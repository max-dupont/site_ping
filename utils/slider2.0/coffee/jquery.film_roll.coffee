  ...
  class @FilmRoll
    ...
    configure: ->
      ...
      unless @options.no_css == true or document.film_roll_styles_added
        $("<style type='text/css'>
.film_roll_wrapper{border-radius: 25px;display:block;text-align:center;float:none;position:relative;top:auto;right:auto;bottom:auto;left:auto;z-index:auto;width:100%;height:100%;margin:0 !important;padding:0 !important;overflow:hidden;}
...
.film_roll_prev,.film_roll_next{text-decoration:none;position:absolute;top:48%;left:15px;width:40px;height:40px;margin:-20px 0 0 0;padding:0;font-size:60px;font-weight:100;line-height:30px;color:white;text-align:center;background:#333;border:3px solid white;border-radius:23px;opacity:0.5}
...
.film_roll_pager a{width:10px;height:10px;border:2px solid white;border-radius:25px;display:inline-block;margin:0 5px;transition:all 1s ease}
.film_roll_pager a:hover{background:#666}
.film_roll_pager a.active{background:white}
