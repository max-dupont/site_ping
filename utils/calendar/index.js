...
// console.log(day);
  ...
  Calendar.prototype.renderEvents = function(events, ele) {
    ...
    if(!events.length) {
      ...
      var span = createElement('span', '', 'Aucun événement');
...
!function() {
  var data = [
    ...
    // { eventName: 'Free Tamale Night', calendar: 'Autres', color: 'green', date: '2018-08-25' },
    // { eventName: 'Bowling Team', calendar: 'Autres', color: 'green', date: '2018-08-25' },
    // { eventName: 'Teach Kids to Code', calendar: 'Autres', color: 'green', date: '2018-08-25' },
    // { eventName: 'Startup Weekend', calendar: 'Autres', color: 'green', date: '2018-08-25' }
  ];
